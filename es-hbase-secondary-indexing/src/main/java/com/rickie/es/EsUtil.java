package com.rickie.es;

import com.alibaba.fastjson.JSON;
import com.rickie.config.ElasticsearchConfig;
...
public class EsUtil <T>{
    public static final String INDEX_TEMPLATE_NAME = "article_template";
    public static final String INDEX_TEMPLATE_JSON_FILE = "article_template.json";
    public static final String INDEX_ALIAS = "articles";
    ...
    public void init() {
        try {
            ...
            if(this.indexTemplateExist(INDEX_ALIAS)) {
